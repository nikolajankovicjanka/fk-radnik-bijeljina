<template>
  <section class="w-full py-16 bg-[#071f36]">
    <h2 class="section-title-revers">
      LATEST RESULTS / NEXT MATCH <span class="n-title-arrow">→</span>
    </h2>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-7">
        ...
        <div v-else class="rounded-2xl bg-white/5 border border-white/10 p-6 text-white/70">
