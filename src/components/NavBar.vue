...
function selectLang(lang: LangOption) {
    ...
    localStorage.setItem('fk_lang', lang.code)

    // TODO: ovdje sutra povežeš i18n (npr. i18n.global.locale.value = lang.code)
}
...
/* Desktop nav link underline: from center -> full width */
.nav-link {
    position: relative;
